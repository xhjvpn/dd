...
def countdown(t):
    ...
    while True:
        if (until - datetime.datetime.now()).total_seconds() > 0:
            stdout.flush()
            stdout.write("\r " + Fore.MAGENTA + "[✔]" + Fore.WHITE + " 攻击倒计时 => " + str(
                (until - datetime.datetime.now()).total_seconds()) + " 秒 ")
        else:
            stdout.flush()
            stdout.write(
                "\r " + Fore.MAGENTA + "[✖]" + Fore.WHITE + " 本次攻击结束                                   \n")
            return
...
##############################################################################################
def get_info_l7():
    stdout.write("\x1b[38;2;255;20;147m • " + Fore.WHITE + "域名    " + Fore.LIGHTCYAN_EX + ": " + Fore.LIGHTGREEN_EX)
    target = input()
    stdout.write("\x1b[38;2;255;20;147m • " + Fore.WHITE + "线程    " + Fore.LIGHTCYAN_EX + ": " + Fore.LIGHTGREEN_EX)
    thread = input()
    stdout.write("\x1b[38;2;255;20;147m • " + Fore.WHITE + "时间(秒)" + Fore.LIGHTCYAN_EX + ": " + Fore.LIGHTGREEN_EX)
    t = input()
    return target, thread, t


def get_info_l4():
    stdout.write("\x1b[38;2;255;20;147m • " + Fore.WHITE + "IP地址  " + Fore.LIGHTCYAN_EX + ": " + Fore.LIGHTGREEN_EX)
    target = input()
    stdout.write("\x1b[38;2;255;20;147m • " + Fore.WHITE + "端口    " + Fore.LIGHTCYAN_EX + ": " + Fore.LIGHTGREEN_EX)
    port = input()
    stdout.write("\x1b[38;2;255;20;147m • " + Fore.WHITE + "线程    " + Fore.LIGHTCYAN_EX + ": " + Fore.LIGHTGREEN_EX)
    thread = input()
    stdout.write("\x1b[38;2;255;20;147m • " + Fore.WHITE + "时间(秒)" + Fore.LIGHTCYAN_EX + ": " + Fore.LIGHTGREEN_EX)
...
def layer7():
    ...
    stdout.write(
        "            " + Fore.LIGHTCYAN_EX + "║ \x1b[38;2;255;20;147m• " + Fore.LIGHTWHITE_EX + "1    " + Fore.LIGHTCYAN_EX + " |" + Fore.LIGHTWHITE_EX + " 没有CDN的域名攻击                 " + Fore.LIGHTCYAN_EX + "║\n")
    stdout.write(
...
##############################################################################################
def title():
    stdout.write("                " + Fore.LIGHTRED_EX + "                            _oo0oo_　　    \n")
    stdout.write("                " + Fore.LIGHTRED_EX + "                           o8888888o 　   \n")
    stdout.write("                " + Fore.LIGHTRED_EX + "                          888  .  888 　 　    \n")
    stdout.write("                " + Fore.LIGHTRED_EX + "                           (| -_- |)  　  　   \n")
    stdout.write("                " + Fore.LIGHTRED_EX + "                           0\  =  /0  　　     \n")
    stdout.write("                " + Fore.LIGHTRED_EX + "                         ___/`---'\___ 　　      \n")
    stdout.write("                " + Fore.LIGHTRED_EX + "                       .' \\|  卐 |// '. 　  　    \n")
    stdout.write("                " + Fore.LIGHTRED_EX + "                      / \\|||  :  |||// \  　　     \n")
    stdout.write("                " + Fore.LIGHTRED_EX + "                     / _||||| -:- |||||- \  　  　   \n")
    stdout.write("                " + Fore.LIGHTRED_EX + "                    |   | \\\  -  /// |   |  　　     \n")
    stdout.write("                " + Fore.LIGHTRED_EX + "                    | \_|  ''\---/''  |_/ |　  　    \n")
    stdout.write("                " + Fore.LIGHTRED_EX + "                    \  .-\__  '-'  ___/-. / 　　    \n")
    stdout.write("                " + Fore.LIGHTRED_EX + "                  ___'. .'  /--.--\  `. .'___ 　　    \n")
    stdout.write("                " + Fore.LIGHTRED_EX + "        　       ."" '<  `.___\_<|>_/___.' >' "". 　　    \n")
    stdout.write("                " + Fore.LIGHTRED_EX + "              | | :  `- \`.;`\ _ /`;.`/ - ` : | |　  　  　   \n")
    stdout.write("                " + Fore.LIGHTRED_EX + "              \  \ `_.   \_ __\ /__ _/   .-` /  / 　  　  \n")
    stdout.write("                " + Fore.LIGHTRED_EX + "          =====`-.____`.___ \_____/___.-`___.-'=====　  　  　  \n")
    stdout.write("                " + Fore.LIGHTRED_EX + "                            `=---='　  　   \n")
    stdout.write("                " + Fore.LIGHTRED_EX + " ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ \n")
    stdout.write("                " + Fore.LIGHTRED_EX + "                          CTRL ╄ C 退出            \n")
    stdout.write("                " + Fore.LIGHTRED_EX + "                          TG  :  EE8866                     \n")
    stdout.write("                " + Fore.LIGHTRED_EX + " ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ \n")
    stdout.write("\n")
...
def command():
    stdout.write(
        Fore.LIGHTCYAN_EX + "　　　　　" + Fore.LIGHTCYAN_EX + '\033[1;92m'+ "[　""输入 1 域名攻击 、输入 2 IP攻击" + Fore.LIGHTGREEN_EX + "　　　" + Fore.LIGHTCYAN_EX + "仅提供学习使用，其他用途后果自负　]" + Fore.CYAN + "　　　" + Fore.LIGHTCYAN_EX + "\n　　　　　\x1b[38;2;0;255;189m> " + Fore.WHITE)
    command = input()
    ...
    ##############################################################################################
        ...
        stdout.write(Fore.MAGENTA + " [>] " + Fore.WHITE + "指令有误，请重新输入\n")
    ##############################################################################################
...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 2:
        ...
        stdout.write(
            "Method: cfb, pxcfb, cfreq, cfsoc, pxsky, 1, http2, pxhttp2, get, post, head, soc, pxraw, pxsoc\n")
